<#
    .SYNOPSIS
    This script will add the Service Principal of an Application as Owner of another (or itself).
    .DESCRIPTION
    ...
    - Global Administrator (or permission Application.ReadWrite.All)
    - Ownership of the application to be set as owned (required temporarily)
    .INPUTS
...
# Hardcoded Azure pwsh client id for prompting authentication
...
$params = @{
    "Method"  = "Get"
    "Uri"     = "https://graph.microsoft.com/v1.0/servicePrincipals?`$filter=appId eq '$($OwnerAppId)'"
    "Headers" = $headers
}
